    ...
    <div className="h-full bg-white lg:rounded-xl shadow-2xl flex flex-col max-h-screen lg:max-h-full">
      ...
      <div className="flex flex-col h-full overflow-hidden">
        ...
        <div className="flex-1 p-4 sm:p-6 space-y-4 overflow-y-auto">
          ...
          {/* Quality Status */}
          <div
            className={`${getQualityBgColor(source.quality)} rounded-lg p-4`}
          >
        ...
        <div className="p-4 sm:p-6 border-t border-gray-200 flex-shrink-0 bg-white">
          <Button
            ...
            className="w-full h-12 sm:h-14 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-semibold text-base sm:text-lg shadow-lg transition-all duration-200"
          >
            Initiate Simulation
          </Button>
        </div>
