...
export default function OnboardingPage() {
  const [selectedRole, setSelectedRole] = useState<"Plant Operator" | "Environmental Officer" | null>(null);
  ...
  const handleRoleSelect = (role: "Plant Operator" | "Environmental Officer") => {
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="signup" className="mt-6">
                <AnimatePresence mode="wait">
                  ...
                  {/* Organization Type */}
                  <div className="space-y-2">
                    <Label htmlFor="org-type" className="text-white">Organization Type</Label>
                    <Select
                  ...
                  {/* Location */}
                  <div className="space-y-2">
                    <Label htmlFor="location" className="text-white">Location (Bangalore)</Label>
                    <Select
