  ...
  const parameterCards = [
    {
      icon: Waves,
      label: "Turbidity (NTU)",
      field: "turbidity" as keyof WaterParameters,
      min: 0,
      max: 1000,
      step: 10,
    ...
    },
    {
      icon: Beaker,
      label: "pH Level",
      field: "pH" as keyof WaterParameters,
      min: 0,
      max: 14,
      step: 0.1,
    ...
    },
    {
      icon: TrendingDown,
      label: "COD (mg/L)",
      field: "cod" as keyof WaterParameters,
      min: 0,
      max: 1000,
      step: 10,
    ...
    },
    {
      icon: Droplets,
      label: "TDS (mg/L)",
      field: "tds" as keyof WaterParameters,
      min: 0,
      max: 2000,
      step: 50,
    ...
    },
    {
      icon: Sparkles,
      label: "Nitrogen (mg/L)",
      field: "nitrogen" as keyof WaterParameters,
      min: 0,
      max: 100,
      step: 1,
    ...
    },
    {
      ...
      field: "phosphorus" as keyof WaterParameters,
      min: 0,
      max: 50,
      step: 0.5,
      ...
      <div className="container mx-auto px-6 pt-32 pb-20">
              ...
              <Card className="bg-white/5 backdrop-blur-lg border-white/10 hover:bg-white/10 transition-all duration-300">
                <CardHeader>
                  <div className="flex items-center gap-3 mb-2">
                    <div className={`p-2 rounded-lg bg-${param.color}-500/20`}>
                      <param.icon
        ...
        >
          <Card className="bg-white/5 backdrop-blur-lg border-white/10">
            <CardHeader>
              ...
              <CardDescription className="text-white/60">
                Select the purpose for which you want to reuse the treated water
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        >
          <p className="text-white/60 text-sm">
            The system will automatically determine the optimal treatment stages
