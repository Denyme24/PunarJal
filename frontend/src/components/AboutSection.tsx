...
const AboutSection = () => {
  const features = [
    {
      ...
      description: "Advanced machine learning algorithms optimize treatment processes in real-time",
    },
    {
      icon: BarChart3,
      title: "Data-Driven Insights",
      description: "Comprehensive analytics provide actionable insights for water management",
    },
    {
      icon: Shield,
      title: "Quality Assurance",
      description: "Multi-stage filtration ensures water meets the highest safety standards",
    },
    {
      icon: Leaf,
      title: "Environmental Impact",
      description: "Sustainable processes reduce carbon footprint and promote circular economy",
    },
    {
      icon: Zap,
      title: "Automated Operations",
      description: "Smart automation reduces manual intervention and operational costs",
    },
    {
      icon: Droplet,
      title: "Water Conservation",
      description: "Maximizes water reuse potential, reducing dependency on freshwater sources",
    },
  ];
  ...
  return (
    <section id="about" className="relative py-32" style={{ backgroundColor: '#1A1C24' }}>
